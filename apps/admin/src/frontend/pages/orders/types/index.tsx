...
import { SECTIONS } from "@workspace/domain/orders/status-groups"
import type { OrderSection, OrderStatus, Section } from "@workspace/domain/orders/status-groups"

export { DEFAULT_PAGE_SIZE, PAGE_SIZES }
export type { PagedResult, SortDir }

// The sections, the status groupings and the two window constants moved to
// @workspace/domain/orders/status-groups when the order door became shared;
// they are re-exported here so every page still imports them from one place.
export {
    ACTIVE_STATUSES,
    ...
    currentYear,
    statusFilter,
} from "@workspace/domain/orders/status-groups"
export type { OrderSection, OrderStatus, Section } from "@workspace/domain/orders/status-groups"
