...
export default async function Data({
    ...
    const input = partnersListInput((key) => {
        const value = search[key]
        return typeof value === "string" ? value : null
    })

    prefetch(trpc.partners.organizations.infiniteQueryOptions(
        { ...input, type: "carrier" as const },
        ...
        <HydrateClient>
            ...
            >
                <Suspense fallback={<DataSkeleton />}>
                    <OrganizationsDataView type="carrier" />
                </Suspense>
            </ErrorBoundary>
        </HydrateClient>
    )
