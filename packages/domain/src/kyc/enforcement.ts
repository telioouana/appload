...
import { carrierEligibility, type EligibilityVerdict } from "@workspace/domain/kyc/eligibility";
import type { FlagReasonCode } from "@workspace/domain/kyc/flag-reason";
import type { CurrentDoc, IsoDate } from "@workspace/domain/kyc/derive";
