...
/**
 * The order columns a debit/credit note writes, named here rather than
 * imported: note-reasons.ts is the app's form-facing vocabulary and stays
 * there, so the columns it can set are restated as the type this module's
 * patch extends.
 */
type NoteOrderPatch = Partial<Pick<
    Order,
