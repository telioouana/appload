...
import { MapPlaceholder } from "@workspace/maps/components/map-placeholder"
...
export function GoogleMapsProvider({ children, missingKeyMessage }: { children: React.ReactNode; missingKeyMessage: string }) {
    const apiKey = process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY

    if (!apiKey) {
        return <MapPlaceholder message={missingKeyMessage} />
    }
